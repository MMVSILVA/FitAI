        ...
        {activeTab === 'chat' && (
          <div className="h-[calc(100vh-200px)] flex gap-6">
            ...
            <div className="flex-1 bg-zinc-950 border border-white/10 rounded-3xl flex flex-col overflow-hidden">
              {selectedChatPatient ? (
                <ChatView selectedProfessional={selectedChatPatient} />
              ) : (
                <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
                  ...
                  <p className="text-gray-500 max-w-xs">Escolha um paciente na lista ao lado para iniciar o acompanhamento com fotos de refeições, exames e documentos.</p>
                </div>
              )}
            </div>
          </div>
