...
export default function Checkout() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      if (data.url) {
        // Redirecionamento na mesma aba é mais confiável e evita bloqueadores de popup
      ...
      // Pequeno delay para garantir que o redirecionamento inicie antes de tirar o loading (estético)
            ...
            {error && (
              <div className="bg-red-500/10 p-5 rounded-2xl border border-red-500/20 text-left space-y-3">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                  Ocorreu um problema ao iniciar o pagamento. Use os botões acima ou entre em contato com o suporte.
                </p>
